...
public:
     ...
     * @param value_ 설정할 값.
     */
    inline void SetUniformInt(const char* const name_, const int value_) const noexcept;
     ...
     * @param value_ 설정할 값.
     */
    inline void SetUniformFloat(const char* const name_, const float value_) const noexcept;
     ...
     * @param value_ 설정할 값.
     */
    inline void SetUniformVector2(const char* const name_, const glm::vec2& value_) const noexcept;
     ...
     * @param value_ 설정할 값.
     */
    inline void SetUniformVector3(const char* const name_, const glm::vec3& value_) const noexcept;
     ...
     * @param value_ 설정할 값.
     */
    inline void SetUniformVector4(const char* const name_, const glm::vec4& value_) const noexcept;
