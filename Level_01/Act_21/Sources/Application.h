...
public:
	...
	/**
	 * @brief 애플리케이션 설정을 지정합니다.
	 * 
	 * @param config_ 애플리케이션 설정
	 */
	static inline void SetSpecification(const Application::Configuration& config_) noexcept;

	/**
	 * @brief GLFW 윈도우 핸들를 반환합니다.
	 * 
	 * @return GLFWwindow* const GLFW 윈도우 핸들
	 */
	[[nodiscard]]
	static inline constexpr GLFWwindow* const GetNativeWindow() noexcept;

	/**
	 * @brief GLFW 윈도우 핸들를 지정합니다.
	 * 
	 * @param window_ GLFW 윈도우 핸들
	 */
